<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                @include('Components/nav-link.php', [ 'route' => 'home', 'name' => 'Home', 'icon' => '
            ...
            <li>
                @include('Components/nav-link.php', [ 'route' => 'grades', 'name' => 'My Grades', 'icon' => '
            ...
            <li>
                @include('Components/nav-link.php', [ 'route' => 'courses', 'name' => 'Courses', 'icon' => '
                <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 transition duration-75" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                @include('Components/nav-link.php', [ 'route' => 'enroll', 'name' => 'Enroll', 'icon' => '
            ...
            <li>
                @include('Components/nav-link.php', [ 'route' => 'profile', 'name' => 'Profile', 'icon' => '
                <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 transition duration-75" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
