    ...
    <div class="w-1/2 p-4 sm:ml-64">
        ...
        <form class="flex items-center mb-4">
            ...
            <div class="relative w-full">
                ...
                <input type="text" name="q" id="search" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5" placeholder="Search" value="{{ $search }}">
            </div>
            <button type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-secondary rounded-lg border border-secondary hover:bg-secondary-hover focus:ring-4 focus:outline-none focus:ring-blue-300">
